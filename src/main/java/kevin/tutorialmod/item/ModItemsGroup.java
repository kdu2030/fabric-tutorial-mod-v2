...
public class ModItemsGroup {
    ...
    public static final ItemGroup RUBY_GROUP = registerItemGroup("ruby", new ItemStack(ModItems.RUBY), ModItems.RUBY, ModItems.RAW_RUBY, ModBlocks.RUBY_BLOCK, ModBlocks.RAW_RUBY_BLOCK, ModBlocks.RUBY_ORE, ModBlocks.DEEPSLATE_RUBY_ORE, ModBlocks.NETHER_RUBY_ORE, ModBlocks.END_STONE_RUBY_ORE, ModItems.METAL_DETECTOR);
