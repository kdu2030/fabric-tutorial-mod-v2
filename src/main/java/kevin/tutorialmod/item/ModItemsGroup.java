...
public class ModItemsGroup {
    ...
    public static final ItemGroup RUBY_GROUP = registerItemGroup("ruby", new ItemStack(ModItems.RUBY), ModItems.RUBY, ModItems.RAW_RUBY, ModBlocks.RUBY_BLOCK, ModBlocks.RAW_RUBY_BLOCK);
